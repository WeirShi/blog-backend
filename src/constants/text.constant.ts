/**
 * @file 文案常量
 * @description 全局路由请求响应文案  参数验证响应文案
 */
...
export const HTTP_USER_EXIST_TEXT = '该用户已存在，请检查输入的手机号！';
export const HTTP_NEED_TOKEN_TEXT = 'The Token is Required!';
export const HTTP_UNAUTHORIZED_TEXT = 'token验证失败！';
export const HTTP_REGIST_SUCCESS_TEXT = '注册成功';
export const HTTP_LOGIN_SUCCESS_TEXT = '登录成功';
